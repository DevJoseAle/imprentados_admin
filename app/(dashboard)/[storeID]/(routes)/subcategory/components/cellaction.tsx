...
export const CellAction: React.FC<CellActionProps> = ({
    ...
    const onDelete = async()=>{
        try {
            setLoading(true)
            await axios.delete(`/api/${params.storeID}/subcategory/${data.id}`);
            router.refresh();
    ...
    const onCopy = (id: string) =>{
        ...
        toast.success('ID de Subcategoria Copiado')
    }
  return (
    <>
        <AlertModal 
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
                ...
                <DropdownMenuItem onClick={()=> router.push(`/${params.storeID}/subcategory/${data.id}`)} >
                    <Edit 
